...
Themes = {
    Darker = {
        ["Color Hub 1"] = ColorSequence.new({
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(99, 0, 0)),
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 0)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(99, 0, 0)),
        }),
        ["Toggle Color"] = ColorSequence.new({
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)),
        }),
        ["Color Hub 2"] = Color3.fromRGB(115, 0, 0),
        ["Color Stroke"] = Color3.fromRGB(0, 0, 0),
        ["Color Theme"] = Color3.fromRGB(115, 0, 0),
...
function redzlib:SetTheme(NewTheme)
    ...
    table.foreach(redzlib.Instances, function(_, Val)
        ...
        elseif Val.Type == "ToggleG" then
            Val.Instance.Color = Theme["Toggle Color"]  
...
local WindowBackground = Create("ImageLabel", MainFrame, {
    ...
    BackgroundTransparency = 1,
    Image = "rbxthumb://type=Asset&id=95075739197246&w=420&h=420", 
    ImageTransparency = 0,
...
local function SpawnCyberpunkSystem()
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "اغلاق",  
			Text = "هل تبي قفل السكربت؟ ؟", -- رساله قفل الواجهه
			Options = {
				{"يب", function()  -- باتن الموافقه ايزي يعني
					ScreenGui:Destroy()
				end},
...
local ToggleHolderGradient = Create("UIGradient", ToggleHolder, {
    Color = Theme["Toggle Color"]
})
...
table.insert(redzlib.Instances, {
    Instance = ToggleHolderGradient,
    Type = "ToggleG"
})

table.insert(redzlib.Instances, {
    Instance = HolderStroke,
    Type = "Stroke"
})
...
task.spawn(function()
    ...
    while ToggleHolder and ToggleHolder.Parent do
        ...
        ToggleHolderGradient.Offset = Vector2.new(offset, 0)
        HolderStroke.Offset = Vector2.new((-offset) % 1, 0)
        task.wait(0.03)
    end
end)
...
local ToggleGradient = Create("UIGradient", Toggle, {
    Color = Theme["Toggle Color"]
})
...
table.insert(redzlib.Instances, {
    Instance = ToggleGradient,
    Type = "ToggleG"
})

table.insert(redzlib.Instances, {
    Instance = ToggleStroke,
    Type = "Stroke"
})
...
task.spawn(function()
    ...
    while Toggle and Toggle.Parent do
        ...
        ToggleGradient.Offset = Vector2.new(offset, 0)
        ToggleStroke.Offset = Vector2.new((-offset) % 1, 0)
        task.wait(0.03)
    end
end)
...
function Tab:AddDiscordInvite(Configs)
	...
	local FrameGradient = Create("UIGradient", FrameHolder, {
		Color = Theme["Color Hub 1"]
	})
	
	table.insert(redzlib.Instances, {
		Instance = FrameGradient,
		Type = "Gradient"
	})
